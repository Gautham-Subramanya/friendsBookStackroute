package com.stackroute.friendsBookStackroute.resource;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.stackroute.friendsBookStackroute.Exceptions.UserAlreadyExistsException;
import com.stackroute.friendsBookStackroute.model.User;
import com.stackroute.friendsBookStackroute.service.UserService;
...
public class UserResourceTests {
    ...
    public void addUsers() throws Exception, UserAlreadyExistsException {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/rest/neo4j/user/addUser")
    ...
    public void getAllUsers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/rest/neo4j/user/allUser")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(user)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
...
//        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/deleteMovieById/1")
